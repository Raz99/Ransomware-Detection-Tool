...
def is_encoded(text):
    ...
    base85_pattern = r"^[!-u]+$"  # Updated to match Base85 range
    ...
    if re.fullmatch(base64_pattern, text):
        ...
        return "URL Encoding"
    elif re.search(r"^begin [0-7]{3} .+\n[ -`]+\nend$", text):
        return "UUencode"  # Enhanced pattern for UUencode format
    elif re.fullmatch(quoted_printable_pattern, text):
        return "Quoted-Printable"
    elif re.fullmatch(base85_pattern, text):
        return "Base85"  # Improved Base85 detection
